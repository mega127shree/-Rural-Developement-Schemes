const SchemeDescription = () => {
    return ( 
        <div className="scheme_description">
          <h2>Chief Minister’s Solar Powered Green House Scheme (CMSPGHS)</h2>  
          <h2>Introduction</h2>
          <p>The Chief Minister’s Solar Powered Green House Scheme (CMSPGHS) was launched during the year 2011-201. It is a flagship scheme of Government of Tamil Nadu, which fulfils the Housing requirement of the rural poor people along with Solar Powered Home Lighting Systems and thereby promoting green energy. Nowhere else in the country such a free housing scheme for the construction of houses with an area of 300 sq.ft with solar powered lighting is implemented.</p>
          <h2>Eligibility of the Beneficiaries</h2>
          <p>You must be a resident of the village panchayat</p>
          <p>Have clear patta for the site/house in the name of the head of the family or any other member of the household.</p>
          <p>You must not have any other owned house/property in village or elsewhere</p>
          <p>Should not have been benefited under any other housing scheme of the Government.</p>
          <h2> Salient features of the Scheme</h2> 
         <p>The poor people living in rural areas are eligible to be beneficiaries of the CMSPGHS.Each house shall be built with an area of 300 square feet at an unit cost of Rs.2.10 lakh fully funded by the State Government.
Each house shall consist of a living room, bed room, kitchen, toilet and verandah apart from the provision of harvesting rain water.Both the construction of houses and installation of solar lights shall be taken up by the Rural Development and Panchayat Raj Department.The Green Houses shall be constructed on the land owned by the beneficiary.People with patta for their house sites are only eligible under this scheme.</p>
