export const SchemeDescriptionData = {
   ...
   SelfSufficiencyScheme:{
    ...
    intro:"It is being implemented by the Government from 2011-12 onwards to encourage and improve the self reliant attitude of public and to enhance their increased participation in creation and maintenance of community infrastructure.",
     eligibilties :[""]
    ...
    IndiraGandhiAwasYojanaScheme:{
        ...
        eligibilties:["The household people living in the rural areas belonging to SC / ST - 60% allocated,","Non-SC/ST - 40% allocated."],
    ...
    ChiefMinisterGreenHouseScheme:{
        title:"Chief Minister Green Home Scheme (CMGHS)",
        intro:"The Chief Minister’s Solar Powered Green House Scheme (CMSPGHS) was launched during the year 2011-12. The flagship scheme has been restructured into Chief Minister Green House Scheme as per G.O(Ms).No.133, Rural Development and Panchayat Raj (SGS-1) Department Dt.03.08.2020.",
        eligibilties:["Be a poor and resident of the Village Panchayat concerned.",
