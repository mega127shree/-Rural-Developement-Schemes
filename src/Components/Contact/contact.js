            ...
            <div className="contact-us-title">
             ...
             <div class="form_container">
                 <form onSubmit={sendEmail} onReset={handleReset} autoComplete="off">
                     ...
                     <input type="text" name="user_email" id="user_email" value={useremail} onChange={event => setUserEmail(event.target.value)}className="input-text"placeholder="Enter Email..." required></input><br></br>
                     
                     <label style={{margin:"350px"}}>Message(queries)</label><br></br>
                     <textarea style={{margin:"10px 346px"}} name='message' id="message" value={message} onChange={event => setMessage(event.target.value)}placeholder="Enter Your message..." required></textarea>  <br></br>
